classdef EvFinderGUI < handle
    ...
    properties 
        ...
        owner@tno.EventFinder; % link back to containg object
...
%             obj.fig.maximize;
            ...
            obj.menu_pars.menu_filters.addButton('button_distances', 'Oort &Distances', 'input', 'pars.oort_distances', 'which distances for the Oort cloud to use for templates');
...
%             obj.menu_pars.menu_filters.addButton('input_oort_bank', 'Oort &Bank', 'input_text', 'pars.filter_bank_oort_filename', 'path and name of the Oort cloud filter bank MAT-file, relative to DATA');
            ...
            obj.panel_plots.addButton('button_cand', 'showCandidates', 'push', 'show candidates', '', '', 1, [], [], 're-render the candidate viewer'); 
