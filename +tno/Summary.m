...
% 
    ...
    methods % constructor
        ...
        function obj = Summary(varargin)
            ...
            if ~isempty(varargin) && isa(varargin{1}, 'tno.Summary')
                if obj.debug_bit>1, fprintf('Summary copy-constructor v%4.2f\n', obj.version); end
                obj = util.oop.full_copy(varargin{1});
            else
                if obj.debug_bit>1, fprintf('Summary constructor v%4.2f\n', obj.version); end
    ...
    methods % calculations
        ...
        function inputHours(obj, hours, stellar_sizes)
            ...
            if nargin<2 || isempty(hours) || ~isa(hours, 'tno.StarHours')
...
%                             ax{ii,jj}.XTick(end) = [];
        ...
        function showDetectionRate(obj, varargin)
            ...
            tno.Summary.showDetectionRateStatic(obj.sim_events, varargin{:}); 
