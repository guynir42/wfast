classdef AnalysisGUI < handle
    ...
    methods % make/update/check GUI
        ...
        function make(obj)
            ...
            obj.panel_controls.addButton('button_flux_hist', 'use_flux_histograms', 'toggle', 'no flux hist', 'use flux hist', 'small', 0.5, obj.color_on, '', 'Calculate the flux histogram for each batch. '); 
...
%             obj.panel_info.addButton('button_fwhm', 'FWHM', 'info', 'FWHM= ', 'pix', '', 0.2); 
            ...
            obj.input_num_rect = GraphicButton(obj.panel_image, [0.15 0.95 0.15 0.05], obj.owner, 'num_stars_used', 'info', ' ', ' stars');
